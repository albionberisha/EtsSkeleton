...
namespace Ets.Data.Repository
{
    public class EtsRepository<Tentity> : IEtsRepository<Tentity> where Tentity : class
    {
        private readonly EtsDbContext _dbContext;

        public EtsRepository(EtsDbContext dbContext)
        {
